    ...
    <div align="center">
        ...
        <form action="<%=ORSView.GET_MARKSHEET_CTL%>" method="post">
            ...
            <%
                ...
                int id = DataUtility.getInt(DataUtility.getStringData(bean.getStudentId()));
                StudentModel sModel = new StudentModel();
                sBean = sModel.findByPk(id);
            ...
            <table border="1" style="border: groove; width: 35%">
                ...
                <tr>
                    ...
                    <th align="center" style="width: 25%; text-transform: uppercase;"><%=DataUtility.getStringData(sBean.getCollegeName())%></th>
                </tr>
            </table>
