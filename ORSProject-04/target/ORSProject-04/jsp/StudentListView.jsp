	...
	<div align="center">
		...
		<form action="<%=ORSView.STUDENT_LIST_CTL%>" method="post">
			...
			<table style="width: 100%">
				<tr>
					<td align="center"><label><b>First Name :</b></label>
			...
			<table style="width: 100%">
				<tr>
					...
					<input type="submit" name="operation" value="<%=StudentListCtl.OP_NEW%>"></td>
					<td align="center" style="width: 25%">
					<input type="submit" name="operation" value="<%=StudentListCtl.OP_DELETE%>"></td>
			...
			<table>
				<tr>
					<td align="right">
					<input type="submit" name="operation" value="<%=StudentListCtl.OP_BACK%>"></td>
				</tr>
			</table>
			<%
				}
