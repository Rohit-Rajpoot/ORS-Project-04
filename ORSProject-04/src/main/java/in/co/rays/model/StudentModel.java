...
//	public StudentBean findByName(String name) throws ApplicationException {
//
//		StringBuffer sql = new StringBuffer("select * from st_student where (first_name + last_name) = ?");
//		StudentBean bean = null;
//		Connection conn = null;
//
//		try {
