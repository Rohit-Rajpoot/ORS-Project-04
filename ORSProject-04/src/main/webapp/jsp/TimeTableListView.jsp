		...
		<form action="<%=ORSView.TIMETABLE_LIST_CTL%>" method="post">
			...
			<table style="width: 100%">
				<tr>
					...
					<input type="submit" name="operation" value="<%=TimeTableListCtl.OP_NEW%>"></td>
					<td align="center" style="width: 25%">
					<input type="submit" name="operation" value="<%=TimeTableListCtl.OP_DELETE%>"></td>
			...
			<table>
				<tr>
					<td align="right">
					<input type="submit" name="operation" value="<%=TimeTableListCtl.OP_BACK%>"></td>
				</tr>
			</table>
			<%
				}
